...
import { FaExternalLinkAlt, FaGithub, FaFlask, FaWater, FaCertificate } from 'react-icons/fa';
...
const Projects = () => {
  ...
  const projects = [
    {
      ...
      description: 'Final year research project focusing on the synthesis and characterization of Hiptage benghalensis Nickel-Manganese based nanocomposites for efficient removal of murexide dye from wastewater.',
      icon: <GiChemicalDrop />,
    ...
    },
    {
      ...
      description: 'Comprehensive water quality assessment using advanced analytical techniques including physical, chemical, and biological testing for environmental monitoring and regulatory compliance.',
      icon: <FaWater />,
    ...
    },
    {
      ...
      description: 'Advanced research utilizing multiple spectroscopic and chromatographic techniques for molecular characterization and quantitative analysis of complex chemical systems.',
      icon: <FaFlask />,
    ...
    },
    {
      ...
      description: 'Comprehensive study of coordination chemistry, group theory applications, and synthesis of organometallic compounds with focus on catalytic and materials applications.',
      icon: <FaFlask />,
  ...
  return (
    <section id="projects" className="relative py-20 bg-gradient-to-b from-slate-800 to-slate-900 overflow-hidden">
      {/* Background Effects */}
      ...
      <div ref={ref} className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-bold text-white mb-4">
            Research & <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-600">Projects</span>
          </h2>
          <div className="w-24 h-1 bg-gradient-to-r from-purple-400 to-pink-600 mx-auto rounded-full" />
          <p className="text-gray-400 mt-4 text-lg">Innovative Chemistry Research & Analysis</p>
        </motion.div>
          ...
          {projects.map((project, index) => (
            ...
            >
              <div className="relative bg-slate-800/50 backdrop-blur-sm border border-purple-500/20 rounded-2xl p-6 h-full hover:border-purple-500/50 transition-all duration-300 overflow-hidden">
                ...
                {/* Icon */}
                <div className={`bg-gradient-to-r ${project.color} p-4 rounded-xl text-white text-3xl w-fit mb-4 relative z-10`}>
                  {project.icon}
                </div>
                ...
                <div className="relative z-10">
                  ...
                  {/* Techniques */}
                  <div className="mb-4">
                    <p className="text-gray-400 text-sm mb-2">Techniques Used:</p>
        ...
        >
          <h3 className="text-3xl font-bold text-white mb-8 text-center">
            Professional <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-600">Certifications</span>
          </h3>
        ...
        >
          <div className="flex items-start gap-6">
            ...
            <div className="flex-1">
              <h3 className="text-2xl font-bold text-white mb-2">Water Quality Analyst</h3>
              <p className="text-purple-400 mb-4">Peace and Development Organization (NGO) | Jan 2023 - Dec 2024</p>
              <ul className="space-y-2 text-gray-300">
                <li className="flex items-start gap-2">
                  <span className="text-purple-400 mt-1">•</span>
                  <span>Collected and analyzed water samples from various sources including rivers, lakes, and treatment plants</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-purple-400 mt-1">•</span>
                  <span>Performed comprehensive physical, chemical, and biological tests for water quality assessment</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-purple-400 mt-1">•</span>
                  <span>Utilized analytical techniques including titration, spectrophotometry, and chromatography</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-purple-400 mt-1">•</span>
                  <span>Ensured compliance with environmental laws, health regulations, and safety protocols</span>
                </li>
              </ul>
            </div>
          </div>

...
//     { icon: <FaAward />, label: 'Projects', value: '3' }
//   ];
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
          ...
          >
            ...
            <div className="space-y-4 text-gray-300 leading-relaxed">
              ...
              <p>
                Additionally, I have worked on the <span className="text-purple-400 font-semibold">synthesis of Ficus Maclellandii King-Zinc-based nanocomposites</span> for the adsorptive removal of Alizarin Red S dye. These eco-friendly materials are characterized with advanced analytical techniques to ensure effective dye removal.
              </p>
              <p>
                I have also conducted <span className="text-purple-400 font-semibold">phytochemical screening and GC-MS analysis of oil extracted from the stem of Citrullus colocynthis</span>, identifying bioactive compounds and exploring their potential medicinal and therapeutic properties.
              </p>
              <p>
                With over 2 years of hands-on laboratory experience as a Water Quality Analyst, I'm skilled in advanced analytical techniques including UV/Visible spectroscopy, HPLC, NMR, IR, and GC-MS.
              </p>
              <p>
                Passionate about <span className="text-purple-400 font-semibold">nanoscience, environmental applications, and natural product research</span>, I'm seeking opportunities in materials chemistry and phytochemical research to contribute to sustainable and innovative solutions.
              </p>
